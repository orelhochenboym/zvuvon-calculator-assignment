...
כלומר אומנם המטוס כרגע נמצא 5000 מטרים מעל הקרקע, אך בגלל שתחתית הבקעה נמצאת 500 מטרים מתחת לפני נקודת ההטלה, הפצצה תעבור מרחק אנכי של 5500 מטרים, לכן הגובה ההתחלתי אמור להיות 5500 ולא 5000, למרות שמד הגובה של המטוס יראה 5000 מטרים מעל פני הקרקע וכרגע המערכת תשתמש בנתון זה לבצע את החישובים.
...
אם כן, עלינו למצוא דרך מתמטית לחשב את פני שטח כדור הארץ ולתרגמם לכדי יכולת לחשב את מיקום פגיעת הפצצה בהתחשב קימור כדור הארץ.
...
יש לנו משתמש שמתחבר אל שרת מרכזי (במקרה שלנו זה main.py)
המשתמש מקבל בחזרה עמוד HTML שבו מתממש הUI ובעצם המשתמש יכול להזין פרמטרים, ולאחר שליחת הנתונים אל השרת המרכזי הוא יקבל את התוצאות ויציג אותן במקום המתאים.